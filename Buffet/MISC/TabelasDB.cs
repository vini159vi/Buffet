    ...
    class TabelasDB
    {
        public override string ToString()
        {
            ...
            return "CREATE TABLE Agenda ( `id` INTEGER PRIMARY KEY AUTOINCREMENT, `nome` VARCHAR(64), `data` DATE, `telefone` BIGINT, `ativo` INTEGER )" +
                   ...
                   "CREATE TABLE Item ( `id` INTEGER PRIMARY KEY AUTOINCREMENT, `nome` VARCHAR(64) UNIQUE, `valorPessoa` DOUBLE, `tipo` INTEGER NOT NULL );" +
